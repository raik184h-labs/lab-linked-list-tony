...
public class MyLinkedListTest {
    ...
    public void setUp() throws Exception {
        ...
        this.mll = new MyLinkedList<Integer>();
        this.mll.addAll(this.list);
    }
    ...
    public void testLastIndexOf() {
        this.mll.add(2);
        assertThat(this.mll.lastIndexOf(new Integer(2)), is(3));
    }
    ...
    public void testRemoveObject() {
        boolean flag = this.mll.remove(new Integer(2));
        assertThat(flag, equalTo(true));
        assertThat(this.mll.size(), is(2));
        assertThat(this.mll.get(1), is(new Integer(3)));
        //System.out.println(Arrays.toString(mal.toArray()));

        flag = this.mll.remove(new Integer(1));
        assertThat(flag, equalTo(true));
        assertThat(this.mll.size(), is(1));
        assertThat(this.mll.get(0), is(new Integer(3)));
        //System.out.println(Arrays.toString(mal.toArray()));
        
        flag = this.mll.remove(new Integer(5));
        assertThat(flag, equalTo(false));
        assertThat(this.mll.size(), is(1));
        assertThat(this.mll.get(0), is(new Integer(3)));
        //System.out.println(Arrays.toString(mal.toArray()));
        
        flag = this.mll.remove(new Integer(3));
        assertThat(flag, equalTo(true));
        assertThat(this.mll.size(), is(0));
        //System.out.println(Arrays.toString(mal.toArray()));
    }
    ...
    @Test
    public void testSet() {
        Integer val = this.mll.set(1, 5);
        assertThat(val, is(new Integer(2)));

        val = this.mll.set(0, 6);
        assertThat(val, is(new Integer(1)));

        val = this.mll.set(2, 7);
        assertThat(val, is(new Integer(3)));

        // return value should be 2
        // list should be [6, 5, 7]
        assertThat(this.mll.get(0), is(new Integer(6)));
        assertThat(this.mll.get(1), is(new Integer(5)));
        assertThat(this.mll.get(2), is(new Integer(7)));
        //System.out.println(Arrays.toString(mal.toArray()));
    ...
    public void testSubList() {
        this.mll.addAll(list);
        List<Integer> sub = this.mll.subList(1, 4);
